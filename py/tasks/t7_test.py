...
from t7 import OrderedList as OrderedList2
from t7 import OrderedStringList as OrderedStringList2
...
class TestOrderedStringList(unittest.TestCase):
    def test_add_strings_preserves_spaces(self):
        osl = OrderedStringList2(asc=True)
        osl.add("  banana ")
        osl.add("apple")
        osl.add("  cherry")
        result = list(osl)
    ...
    def test_add_strings_descending_order(self):
        osl = OrderedStringList2(asc=False)
        osl.add("  banana ")
        osl.add("apple")
        osl.add("  cherry")
        result = list(osl)
